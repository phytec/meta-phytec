...
SRC_URI_class-devupstream = "git://git.phytec.de/u-boot-stm32mp;protocol=git;branch=${U_BOOT_VERSION}-phy"
SRCREV_class-devupstream = "f13e80c22adacbc51414b547687de581a84a43ed"
