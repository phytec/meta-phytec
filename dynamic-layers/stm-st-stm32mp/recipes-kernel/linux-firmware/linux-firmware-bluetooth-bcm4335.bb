...
LICENSE:${PN} = "Firmware-cypress-bcm4335"
LICENSE:${PN}-cypress-license = "Firmware-cypress-bcm4335"

FILES:${PN}-cypress-license = "${nonarch_base_libdir}/firmware/LICENCE.cypress_bcm4335"
